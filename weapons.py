...
class Axe(Weapon):
    ...
    def shoot(self,space,pos,face,parent):
        ...
        if len(parent.shotList)<self.maxShot:
            ...
            newShot=shots.SpreadShot(space,pos.x+16*self.face[0],pos.y+16*self.face[1],self.face[0],self.face[1])
            parent.shotList.append(newShot)
            spreadShot=shots.SubShot(space,pos.x+16*self.face[0],pos.y+16*self.face[1],faceLeft[0],faceLeft[1])
            parent.shotList.append(spreadShot)
            spreadShot=shots.SubShot(space,pos.x+16*self.face[0],pos.y+16*self.face[1],faceRight[0],faceRight[1])
            parent.shotList.append(spreadShot)
            return True
        else: return False
